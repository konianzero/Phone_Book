...
public class BinarySearch implements Search {
    ...
    public long search(PhoneDirectory directory, String[] names) {
        final Function<String, Optional<Long>> search = name -> binarySearch(directory, name);
    ...
    private Optional<Long> binarySearch(PhoneDirectory directory, String name) {
        int left = 0;
        ...
        while (left <= right) {
            ...
            else              { return Optional.of(directory.getEntry(mid).getPhone()); } // if (cmp == 0) the element is found
        }
